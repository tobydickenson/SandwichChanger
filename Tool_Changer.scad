...
offset = 10.0; // [0:0.01:20.0]

translate([0, 0, 3.5+2*offset]) color([0.8, 0.5, 1])  { include <Tool_Changer_Top.scad> }

translate([0, 0, 1.5+1*offset]) color([0, 1, 0.2]) { include <Tool_Changer_Middle.scad> }
